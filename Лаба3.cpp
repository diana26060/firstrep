...
//написать функцию для вывода матрицы, кот-ю ввёл пользователь
void printUserMatrix(const vector<vector<int>>& matrix, int size){
     cout << "Users Matrix: " << endl;
     for (int i = 0; i<size; i++) {
        for (int j = 0; j<size; j++) {
            cout << matrix[i][j] << " ";
        }
